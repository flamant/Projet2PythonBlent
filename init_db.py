...
def add_sample_products_and_add_admin_and_client():
    ...
    users = [
        User(email='admin@login.fr', password=hashed_admin, firstName="firstName1", lastName="lastName1", client=False, administrator=True),
        User(email='flamant@club-internet.fr', password=hashed_antoine, firstName="xavier", lastName="flamant",client=True, administrator=False)
    ]
